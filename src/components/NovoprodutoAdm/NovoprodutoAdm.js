...
const NovoprodutoAdm = () => {
    ...
    useEffect(() => {
        api.get('/produtos').then((res) => console.log(res.data)).catch((erro) => console.log(erro))
    }, [])

    function deletar(btn) {
        api.delete(`/produtos/${btn.target.value}`).then((res) => console.log(res.data)).catch((erro) => console.log(erro))
    }
        ...
        <>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6">
                        <h1 class="display-5 fw-bold center pt-5 pb-5" style={{ textAlign: 'center' }} >Incorporar Produto</h1>
